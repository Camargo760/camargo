          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map((product) => (
              <div key={product._id} className="border bg-white rounded-lg shadow-md p-4">
                ...
                <p className="text-sm mb-2"><span className="font-semibold">Category:</span> {product.category}</p>
                <p className="text-sm mb-2"><span className="font-semibold">Colors:</span> {product.availableColors ? product.availableColors.join(', ') : 'N/A'}</p>
                <p className="text-sm mb-2"><span className="font-semibold">Sizes:</span> {product.availableSizes ? product.availableSizes.join(', ') : 'N/A'}</p>
                <p className="text-sm mb-2"><span className="font-semibold">Uploaded:</span> {new Date(product.uploadTime).toLocaleString()}</p>
              ...
              <tbody>
                {orders.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">{order.customer.name || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">{order.customer.email || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">{order.customer.phone  || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">{order.customer.address || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">{order.product.name || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">${(order.amount_total / 100).toFixed(2) || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap border-b border-gray-300">{new Date(order.created * 1000).toLocaleDateString() || 'N/A'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
