  ...
  return (
    <header className="sticky top-0 left-0 w-full h-[60px] bg-gradient-to-r from-black to-gray-800 shadow-md px-10 py-4 flex items-center justify-center z-50">
      <nav className="max-w-[1200px] w-full flex justify-between items-center">
        ...
        <div
          className={`md:flex items-center justify-between gap-10 ${menuOpen ? "flex" : "hidden"} 
          ...
          {session ? (
            <>
              ...
              <button
                ...
                className="bg-red-500 hover:bg-red-600 text-white px-5 py-2 rounded-lg text-base cursor-pointer transition-colors duration-300"
              >
                Sign Out
              </button>
            </>
            ...
            <>
              ...
              <Link
                href="/signup"
                className="bg-green-400 hover:bg-green-600 text-white px-5 py-2 rounded-lg text-base cursor-pointer transition-colors duration-300"
              >
                Sign Up
              </Link>
            </>
