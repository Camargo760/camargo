                ...
                {filters.map((filter) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all ${selectedFilter === filter.value ? "opacity-100" : "opacity-70 hover:opacity-90"
                                }`}
                            style={{
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center space-x-2 px-6 py-4 font-medium transition-all ${activeTab === tab.value ? "opacity-100" : "opacity-70 hover:opacity-90"
                                    }`}
                                style={{
